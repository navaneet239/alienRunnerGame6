...
var devil, devilbk1, devilGroup1;

var devil2, devilbk2, devilGroup2;

var devil3, devilbk3, devilGroup3;
...
var startbk;
 ...
 var lifeS, lifebk, lifeCount = 200;
...
function preload() {
  ...
  devilbk1 = loadImage("devil_d.png");

  devilbk2 = loadImage("devil_e.png");

  devilbk3 = loadImage("devil_r.png");
  ...
  innbk = loadImage("abstract-circle-20-4k.jpg");

  lifebk = loadAnimation("life1.png", "life2.png", "life3.png", "life4.png", "life5.png", "life6.png", "life7.png", "life8.png", "life9.png", "life10.png", "life11.png");
...
function setup() {
  ...
  devilGroup1 = createGroup();

  devilGroup2 = createGroup();

  devilGroup3 = createGroup();
  ...
  lifeS = createSprite(width/2 - 100, 25, 100, 50);
  lifeS.addAnimation("LifeRotation", lifebk);
  lifeS.scale = 0.15;
}
...
function draw() {
  ...
  text("  Your total life = " + lifeCount, lifeS.x + 20, pack4.y + 5);
  ...
  if (gameState === PLAY) {
    ...
    if(devilGroup1.isTouching(alien)){
      score = 0;
      packItem4 = 0;
    }

    if(devilGroup2.isTouching(alien)){
      score = 0;
      packItem5 = 0;
    }
    
    if(devilGroup3.isTouching(alien)){
      score = 0;
      packItem6 = 0;
    }
  ...
  if (gameState === END){
    ...
    devilGroup1.setVelocityXEach(0);
    devilGroup1.destroyEach();
    devilGroup2.setVelocityXEach(0);
    devilGroup2.destroyEach();
    devilGroup3.setVelocityXEach(0);
    devilGroup3.destroyEach();
    ...
    devilGroup1.setLifetimeEach(-1);
    devilGroup2.setLifetimeEach(-1);
    devilGroup3.setLifetimeEach(-1);
...
function evil1() {
  ...
  if (frameCount % 100 === 0) {
    devil1 = createSprite(width, 220, 20, 20);
    devil1.addImage(devilbk1);
    devil1.scale = 0.75;
    devil1.velocityX = -(8 + 3 * score / 100);
    
    devil1.setCollider("rectangle",0,0,75,125,0);
    devil1.debug = false;
    
    devil1.lifetime = width/-(8 + 3 * score / 100);
    
    devilGroup1.add(devil1);
...
function evil2() {
  ...
  if (frameCount % 150 === 0) {
    devil2 = createSprite(width, 220, 20, 20);
    devil2.addImage(devilbk2);
    devil2.scale = 0.75;
    devil2.velocityX = -(8 + 3 * score / 100);
    
    devil2.setCollider("rectangle",0,0,75,125,0);
    devil2.debug = false;
    
    devil2.lifetime = width/-(8 + 3 * score / 100);
    
    devilGroup2.add(devil2);
...
function evil3() {
  ...
  if (frameCount % 200 === 0) {
    devil3 = createSprite(width, 220, 20, 20);
    devil3.addImage(devilbk3);
    devil3.scale = 0.75;
    devil3.velocityX = -(8 + 3 * score / 100);
    
    devil3.setCollider("rectangle",0,0,75,125,0);
    devil3.debug = false;
    
    devil3.lifetime = width/-(8 + 3 * score / 100);
    
    devilGroup3.add(devil3);
...
function evil4() {
  ...
  if (frameCount % 300 === 0) {
    ...
    skull.setCollider("rectangle",0,0,75,125,0);
    skull.debug = false;
